...
impl Editor {
    ...
    fn draw_welcome_message(&self) {
        ...
        let spaces = " ".repeat(padding.saturating_sub(GUTTER_CHAR.len()));

        welcome_message = format!("{GUTTER_CHAR}{spaces}{welcome_message}");
    ...
    fn draw_status_bar(&self) {
        ...
        status = format!("{file_name} - {length} lines{modified_indicator}");
    ...
    fn search(&mut self) {
        ...
        if let Some(query) = query_result.unwrap_or(None) {
